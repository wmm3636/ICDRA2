export const welcomeEmailTemplate = (firstName: string, email: string, tempPassword: string) => {
    ...
    <head>
        ...
        <title>Welcome to ICDRA 2026</title>
    </head>
    <body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f4f4f4;">
        <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
            <div style="background-color: #2563eb; padding: 20px; text-align: center;">
                <h1 style="color: #ffffff; margin: 0; font-size: 24px;">Welcome to ICDRA 2026</h1>
            ...
            <div style="padding: 40px 20px;">
                ...
                <p style="color: #666666; line-height: 1.6; margin-bottom: 30px;">
                    Your account has been successfully created for ICDRA 2026. You can now access the conference platform using the credentials below:
                </p>
                ...
                <p style="color: #666666; line-height: 1.6; margin-bottom: 20px;">
                    You can access the ICDRA 2026 platform and update your password through your account settings.
                </p>
                ...
                <div style="text-align: center; margin: 40px 0;">
                    <p style="color: #666666; margin-bottom: 15px;">Welcome to ICDRA 2026!</p>
                    <p style="color: #999999; font-size: 14px;">The ICDRA 2026 Team</p>
                </div>
